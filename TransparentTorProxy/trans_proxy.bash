...
function get_set_windowname() {
    ...
    # Set screen name
    xdotool getactivewindow set_window --name "Local Transparent Tor Proxy"
...
function print_header() {
    ...
    echo -e "\e[44m╔══════════════════════════════════════════════════════════════════════════════╗\e[49m"
    echo -e "\e[44m║                         Local Transparent Tor Proxy                          ║\e[49m"
    echo -e "\e[44m║                                Version 0.0.2                                 ║\e[49m"
    echo -e "\e[44m║                            © 2018, Dr. Peter Netz                            ║\e[49m"
...
function main_menu() {
    ...
    do
        ...
        choice=$(dialog --backtitle "Local Transparent Tor Proxy" \
                        --title " Main Script Menu " \
                        --ok-label     " Your Selection " \
                        --cancel-label "  Leave Script  " \
                        --menu "Possible selections:" 0 0 0 \
                 "1" "Start the local transparent Tor proxy" \
                 "2" "Stop the local transparent Tor proxy" \
