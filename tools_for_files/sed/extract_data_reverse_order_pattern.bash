...
# the data is extracted from the line and printed out line by line.
# Empty lines are ignored and if there is no valid data the field is ignored.
# The pattern is printed and if there was no space between pattern and data the
# space is added.
#
...
sed -n '
/\;/ {                            # Match only lines with the pattern.
