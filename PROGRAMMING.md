...
> [!CAUTION]
> <p align="justify">See also reference [4] section '22. cmd1 && cmd2 || cmd3'. There the pitfall of misleading usage of short-circuit evaluations will be shown and explained.</p>p>
